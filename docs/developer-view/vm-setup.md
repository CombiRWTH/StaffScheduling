...
- This will execute a script found at `C:\Tools\run.bat` (or in the repo at `legacy/src/run.bat`) and launch the [workflow frontend](./web-interface.md) for the selected month and station.
