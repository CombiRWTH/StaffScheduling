...
from tests.cp.constraints import test_min_rest_time, test_planned_shifts


def test_min_rest_x_planned_shifts_1(
    ...
    constrain1 = MinRestTimeConstraint(employees, days, shifts)
    ...
    violations1 = test_min_rest_time.find_min_rest_time_violations(solver, variables_dict, employees, days, shifts)
