...
from building_constraints.not_too_long_shifts import not_too_long_shifts
...
def add_all_constraints(
    ...
    # Add not too long shifts constraint
    ...
    not_too_long_shifts(model, shifts, num_days, num_persons, num_shifts, shift_id_map)
