...
class FSLoader(Loader):
    ...
    def get_employees(self, start: int = 0) -> list[Employee]:
        ...
        # {'A-Pflegefachkraft (Krankenpflege) (A-81302-018)': 'Azubi', 'A-Pflegeassistent/in (A-81302-014)': 'Azubi', 'Pflegefachkraft (Krankenpflege) (81302-018)': 'Fachkraft', 'Gesundheits- und Krankenpfleger/in (81302-005)': 'Fachkraft', 'Krankenschwester/-pfleger (81302-008)': 'Fachkraft', 'Altenpfleger/in (82102-002)': 'Fachkraft', 'Krankenpflegehelfer/in (1 jährige A.) (81301-006)': 'Hilfskraft', 'Pflegeassistent/in (81302-014)': 'Hilfskraft', 'Helfer/in - stationäre Krankenpflege (81301-002)': 'Hilfskraft', 'Stationshilfe (81301-018)': 'Hilfskraft', 'Bundesfreiwilligendienst (BFD)': 'Hilfskraft', 'Medizinische/r Fachangestellte/r (81102-004)': 'Hilfskraft'}
