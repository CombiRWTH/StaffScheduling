            ...
            for day in self._days[:-1]:
                for station in self._stations:
                    for station_tomorrow in self._stations:
                        late_today = shift_assignment_variables[employee][day][self._shifts[Shift.LATE]][station]
                        early_tomorrow = shift_assignment_variables[employee][day + timedelta(1)][
                            self._shifts[Shift.EARLY]
                        ][station_tomorrow]
